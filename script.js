...
button.textContent = "love you ❤"; // Set button text
        button.className = "valentines-button"; // Add CSS class for styling
...
function drawText() {
    ...
    if(frameNumber > 2500 && frameNumber < 99999){
        ...
        if (window.innerWidth < 600) {
            drawTextWithLineBreaks(["I love you so much vania🤍, more than", "all the time and space in the universe can contain"], canvas.width / 2, canvas.height / 2, fontSize, lineHeight);
        } else {
            context.fillText("I love you so much vania🤍, more than all the time and space in the universe can contain", canvas.width/2, canvas.height/2);
        }
    ...
    if(frameNumber >= 3000 && frameNumber < 99999){
        ...
        context.fillText("love youu <3", canvas.width/2, (canvas.height/2 + 120));
